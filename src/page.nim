...
proc main(args: seq[string]) =
  ...
  let
    fHelp = argp.flag("h", "help", help="Prints the help message.")
    fVersion = argp.flag("v", "version", help="Prints the language version and exits.")
    fRepl = argp.flag("repl", help="Runs the Page REPL.")
    fExec = argp.opt("e", "exec", help="Executes the given Page snippet.")
    fTokens = argp.flag("t", "tokens", help="Prints the tokens generated by the lexer.")
    fNodes = argp.flag("n", "nodes", help="Prints the nodes generated by the parser.")
    fLogLevel = argp.opt("log", help="Sets the log level; debug messages are NOT guaranteed to be the same between versions.")
    fForceStd = argp.flag("fstd", "force-std", help="Force the standard library to be written; this is normally skipped after the first time Page is run.")
